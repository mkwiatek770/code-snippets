...
class TestSearchPerformance(unittest.TestCase):
    ...
    def test_binary_search(self):
        ...
        t1 = time.perf_counter()
        print(f"To binary find item 1000 it took {t1-t0} secs")
        self.assertTrue(res)
        ...
        t1 = time.perf_counter()
        print(f"To binary find item 500_001 it took {t1-t0} secs")
        self.assertTrue(res)
        ...
        t1 = time.perf_counter()
        print(f"To binary find item -1 it took {t1-t0} secs")
        self.assertFalse(res)
